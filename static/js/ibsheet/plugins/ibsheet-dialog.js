...
/* 피벗 다이얼로그 생성 메소드*/
Fn.createPivotDialog = function (width, height, name, showType) {
  // 스타일이 중복 되었을때 스타일을 제거한다.
  ...
  var pivotTypes = self.producePivotTypes();
  ...
  dialogOpt.Body = "<div class='" + themePrefix + classDlg + "' style='width:" + width + "px;height:" + height + "px;' onmousedown='return false' onkeyup='" + this.id + ".closePivotDialog(event)' onmouseup='" + this.id + ".PivotDragMouseUp(event)' onmousemove='" + this.id + ".PivotDragMouseMove(event)'>" +
    ...
    "<div style='overflow-y:auto; height:" + (showType ? "154" : "180") + "px;padding:7px;background-color:#FFFFFF' onselectstart='return false;' onmouseup='" + this.id + ".PivotDragSetItem(this,event)' ontouchstart='return false'> " +
    pivotCols[0] +
    "</div>" +
    "</div>" +
    "<div style='height:50%'>" +
    "<div style='border-bottom: 1px solid #c5c5c5;border-top: 1px solid #c5c5c5;'>대상 컬럼(숫자형)</div>" +
    "<div style='overflow-y:auto; height:" + (showType ? "153" : "179") + "px;padding:7px;background-color:#FFFFFF' onselectstart='return false;' onmouseup='" + this.id + ".PivotDragSetItem(this,event)' ontouchstart='return false'> " +
    pivotCols[1] +
    "</div>" +
    "</div>" +
    "</div>" +
    ...
    "<div id='" + name + "_PivotRow' class='" + name + "_PivotStandards' style='height:" + (showType ? "86" : "107") + "px;padding:7px; overflow-y: auto;background-color:#FFFFFF;' onmouseup='" + this.id + ".PivotDragSetItem(this,event,1)'>" +
    ...
    "<div id='" + name + "_PivotCol' class='" + name + "_PivotStandards' style='height:" + (showType ? "85" : "107") + "px;padding:7px; overflow-y: auto;background-color:#FFFFFF;' onmouseup='" + this.id + ".PivotDragSetItem(this,event,1)'>" +
    ...
    "<div id='" + name + "_PivotData' class='" + name + "_PivotStandards' style='height:" + (showType ? "89" : "107") + "px;padding:7px; overflow-y: auto;background-color:#FFFFFF;' onmouseup='" + this.id + ".PivotDragSetItem(this,event,2)'>" +
  ...
  btnCreate.onclick = function () {
    ...
    var pivotType = document.querySelector("input[name='PivotTypes']:checked") && document.querySelector("input[name='PivotTypes']:checked").value;
    ...
    setTimeout(function () {
      ...
      self.makePivotTable(criterias, init, null, pivotType);
    }, 10)
    result.Close();
...
Fn.producePivotTypes = function () {
  ...
  if (types && types.length > 0) {
    for (var i = 0; i < types.length; i++) {
      ...
      input = "<input type=\'radio\' name=\'PivotTypes\' value=\'" + types[i] + "\'" + (types[i] == "Sum" ? " checked>": ">");
